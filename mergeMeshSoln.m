function [Elements, Nodes, Solution] = mergeMeshSoln(E1,N1,a1,E2,N2,a2)
    %IDENTICAL TO mergeMesh BUT also merges sol'ns a1,a2 defined at the nodes
    ...
    nanDetector = isnan(new_nodes(:,1));
    new_nodes(nanDetector,:) = [];
    new_a(nanDetector,:) = [];
